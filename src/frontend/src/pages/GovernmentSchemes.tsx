...
const schemes: Scheme[] = [
  {
    name: "PM-KISAN",
    description:
      "Pradhan Mantri Kisan Samman Nidhi provides direct income support of ₹6,000 per year to all landholding farmer families across India. The amount is transferred in three equal installments of ₹2,000 directly to the bank accounts of beneficiaries. This scheme aims to supplement the financial needs of farmers in procuring inputs for crop health and yield. Over 11 crore farmers have benefited since its launch in 2019.",
    benefits: [
    ...
    eligibility:
      "All landholding farmer families with cultivable land. Excludes institutional landholders, government employees, income tax payers, and professionals.",
  ...
  },
  {
    ...
    eligibility:
      "All farmers growing notified crops in notified areas. Mandatory for loanee farmers; voluntary for non-loanee farmers.",
  ...
  },
  {
    ...
    eligibility:
      "All farmers including tenant farmers, oral lessees, sharecroppers, and SHG/JLG members engaged in agriculture and allied activities.",
  ...
  },
  {
    name: "NMSA",
    description:
      "National Mission for Sustainable Agriculture promotes sustainable farming practices to enhance agricultural productivity while conserving natural resources. The mission focuses on soil health management, water use efficiency, and climate change adaptation. It integrates traditional knowledge with modern technology to develop location-specific farming systems. NMSA supports organic farming, integrated farming systems, and precision agriculture.",
    benefits: [
    ...
    eligibility:
      "All farmers, especially those in rain-fed areas, hill regions, and areas prone to climate variability. Priority to small and marginal farmers.",
  ...
  },
  {
    ...
    eligibility:
      "All farmers across India. Soil samples collected from every 2.5 hectares in irrigated areas and 10 hectares in rain-fed areas.",
  ...
  },
  {
    ...
    eligibility:
      "All farmers with agricultural land. Priority to small/marginal farmers, SC/ST farmers, and farmers in water-stressed areas.",
  ...
  },
  {
    ...
    eligibility:
      "State governments implement schemes for farmers. Individual farmers benefit through state-level programs for infrastructure, technology, and market access.",
  ...
  },
  {
    ...
    eligibility:
      "Farmers willing to convert to organic farming. Organized in clusters of 50 farmers covering 50 acres. Priority to traditional organic farming areas.",
  ...
  },
  {
    ...
    eligibility:
      "Farmers in identified NFSM districts across India. Priority to small and marginal farmers in low-productivity areas.",
  ...
  },
  {
    ...
    eligibility:
      "All horticulture farmers. Special focus on NE states, Himalayan states, and tribal areas. Subsidy varies by category and state.",
  ...
  },
  {
    ...
    eligibility:
      "Farmers growing notified oilseeds, pulses, and copra in states that have signed MoU with central government for scheme implementation.",
  ...
  },
  {
    ...
    description:
      "Agriculture Infrastructure Fund (AIF) provides medium-long term debt financing for investment in viable projects for post-harvest management infrastructure and community farming assets. The scheme offers interest subvention of 3% per annum on loans up to ₹2 crore. Credit guarantee coverage is provided through CGTMSE for loans up to ₹2 crore. AIF has mobilized over ₹30,000 crore investment in agri-infrastructure.",
    benefits: [
    ...
    eligibility:
      "Farmers, FPOs, PACS, cooperatives, agri-entrepreneurs, startups, and central/state agencies for post-harvest and agri-infrastructure projects.",
  ...
  },
  {
    ...
    eligibility:
      "All farmers with priority to small/marginal farmers, SC/ST farmers, and women farmers. FPOs and cooperatives eligible for Custom Hiring Centers.",
  ...
  },
  {
    name: "NBHM",
    description:
      "National Beekeeping and Honey Mission promotes scientific beekeeping for improving crop productivity through pollination and generating additional income for farmers. The mission aims to make India the largest honey producer globally. Financial assistance is provided for bee colonies, beehives, honey processing equipment, and training. NBHM supports the establishment of Integrated Beekeeping Development Centers across India.",
    benefits: [
    ...
    eligibility:
      "Farmers, unemployed youth, women, and tribal communities interested in beekeeping. FPOs and cooperatives for large-scale operations.",
  ...
  },
  {
    ...
    eligibility:
      "Fishers, fish farmers, fish workers, fish vendors, FPOs, cooperatives, and entrepreneurs in fisheries sector. SC/ST and women get additional subsidy.",
  ...
  },
  {
    ...
    eligibility:
      "All livestock farmers including cattle, buffalo, sheep, goat, pig, and poultry farmers. Priority to small/marginal farmers and women.",
  ...
  },
  {
    name: "e-NAM",
    description:
      "National Agriculture Market (e-NAM) is a pan-India electronic trading portal that networks existing APMC mandis to create a unified national market for agricultural commodities. Farmers can sell their produce online to buyers across India, getting better prices through transparent price discovery. The platform has over 1.76 crore registered farmers and 2.39 lakh traders. e-NAM has facilitated trade worth over ₹2 lakh crore since its launch.",
    benefits: [
    ...
    eligibility:
      "All farmers in states/UTs that have joined e-NAM platform. Farmers need to register at their nearest e-NAM mandi with Aadhaar and bank account.",
  ...
  },
  {
    name: "Agri-UDAAN",
    description:
      "Agri-UDAAN is a mentorship program that helps agri-food startups scale their businesses and connect with investors, mentors, and markets. The program provides intensive mentoring, networking opportunities, and access to government schemes for agricultural innovation. It focuses on technology-driven solutions for farm productivity, supply chain, and market access. Agri-UDAAN has supported over 500 agri-startups across India.",
    benefits: [
    ...
    eligibility:
      "Agri-food startups and entrepreneurs with innovative solutions for agriculture. Focus on technology-driven solutions for farm productivity and market access.",
    officialWebsite: "https://agricoop.nic.in",
      ...
      <section className="relative bg-gradient-to-br from-primary/90 to-primary/60 text-primary-foreground py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg md:text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Discover and apply for government schemes designed to support Indian
            farmers with financial aid, insurance, credit, and modern farming
            resources.
          </p>
              ...
              {filteredSchemes.map((scheme, index) => (
                <AnimatedSection key={scheme.name} delay={index * 60}>
                  <div className="eco-card h-full flex flex-col group hover:shadow-lg transition-shadow duration-300">
                    {/* Card Header */}
                    <div
                      className={`bg-gradient-to-br ${scheme.color} rounded-t-xl p-5 flex items-start gap-3`}
                    >
        ...
        <div className="max-w-3xl mx-auto text-center">
          <AnimatedSection>
            ...
            <p className="text-muted-foreground mb-6 text-base">
              Our team can guide you through the application process for any
              government scheme. Reach out to us for personalized assistance.
            </p>
            <a
              href="/contact"
