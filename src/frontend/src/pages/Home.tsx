      ...
      <section className="py-16 bg-eco-light">
        <div className="max-w-7xl mx-auto px-4">
          <AnimatedSection animation="slideUp">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-display font-bold text-eco-dark mb-3">
                Region-wise Crop Guide
              </h2>
              <p className="text-gray-600">
                Discover the best crops for your region
              </p>
            </div>
          </AnimatedSection>
            ...
            {regionCrops.map((r, i) => (
              <AnimatedSection key={r.region} animation="fadeIn" delay={i * 80}>
                <div className="bg-white rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                  <h3 className="font-bold text-eco-primary mb-3">
                    {r.region}
                  </h3>
                  <ul className="space-y-1">
                    {r.crops.map((crop) => (
                      ...
                      >
                        <Sprout size={14} className="text-eco-secondary" />{" "}
                        {crop}
                      </li>
                    ))}
                  </ul>
          ...
          <div className="text-center">
            <Link
              to="/crop-suggestions"
              className="eco-btn-primary inline-flex items-center gap-2"
            >
        ...
        <div className="max-w-7xl mx-auto px-4">
          <AnimatedSection animation="fadeIn">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-600">
                Key schemes supporting Indian farmers
              </p>
            </div>
          </AnimatedSection>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            {[
              {
                ...
                desc: "Using IoT sensors and data analytics for optimized crop management",
                icon: "📡",
              },
              {
                title: "Drone Technology",
                desc: "Aerial monitoring and precision spraying for large-scale farms",
                icon: "🚁",
              },
              {
                title: "AI-Powered Insights",
                desc: "Machine learning for crop disease detection and yield prediction",
                icon: "🤖",
              },
            ].map((item, i) => (
              <AnimatedSection
              ...
              >
                <div className="bg-white/10 rounded-xl p-6 text-center hover:bg-white/20 transition-colors">
                  ...
                  <h3 className="font-bold text-eco-accent mb-2">
                    {item.title}
                  </h3>
          ...
          <AnimatedSection animation="fadeIn">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-6">
              <a
                ...
                className="flex items-center gap-2 text-white hover:text-eco-accent transition-colors"
              >
