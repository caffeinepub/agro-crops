import { Eye, Mail, Phone, Target, Users } from "lucide-react";
...
const team = [
  {
    ...
    initials: "CK",
    phone: "8421016006",
    email: "kharatchaitanya03@gmail.com",
  },
  {
    name: "Aditya Anarase",
            ...
            <AnimatedSection animation="slideUp">
              <div className="bg-eco-light rounded-2xl p-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-2xl font-display font-bold text-eco-dark">
                    {t("ourMission")}
                  </h2>
                </div>
            ...
            {team.map((member, i) => (
              ...
              >
                <div className="bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="font-bold text-eco-dark mb-1">
                    {member.name}
                  </h3>
                  ...
                  <div className="space-y-1">
                    {member.email && (
                      <a
                        ...
                        className="flex items-center justify-center gap-1 text-xs text-gray-500 hover:text-eco-primary transition-colors"
                      >
