    ...
    <footer className="bg-eco-dark text-white">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-lg mb-4 text-eco-accent">
              {t("quickLinks")}
            </h3>
            <ul className="space-y-2">
              {[
                ...
                <li key={link.to}>
                  <Link
                    to={link.to}
                    className="text-gray-300 hover:text-eco-accent text-sm transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-sm text-gray-300">
                ...
                <a
                  ...
                  className="hover:text-eco-accent transition-colors"
                >
              ...
              <li className="flex items-start gap-2 text-sm text-gray-300">
                <MapPin
                  size={16}
                  className="text-eco-accent flex-shrink-0 mt-0.5"
                />
