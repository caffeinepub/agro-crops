...
const techniques = [
  {
    ...
    name: "Composting",
    overview:
      "Transform organic waste into nutrient-rich compost to improve soil health and fertility naturally.",
    steps: [
      "Collect organic waste (kitchen scraps, crop residues)",
  ...
  },
  {
    ...
    overview:
      "Use biological and botanical methods to manage pests without harmful chemicals.",
    steps: [
      "Identify pest species correctly",
      "Introduce beneficial insects (ladybugs, lacewings)",
      "Apply neem oil spray",
      "Use sticky traps for monitoring",
      "Plant companion crops as deterrents",
    ],
    benefits: [
    ...
    proTip:
      "Spray neem oil in the evening to avoid harming beneficial pollinators.",
  },
  {
    id: 3,
    icon: "🔄",
    name: "Crop Rotation",
    overview:
      "Systematically change crops in a field each season to maintain soil health and break pest cycles.",
    steps: [
      "Plan 3-4 year rotation schedule",
      "Alternate legumes with cereals",
      "Include cover crops in rotation",
      "Document crop history per plot",
    ...
    proTip:
      "Always follow a nitrogen-fixing legume with a heavy feeder like corn or wheat.",
  },
  {
    id: 4,
    icon: "🍂",
    name: "Mulching",
    overview:
      "Cover soil with organic materials to retain moisture, suppress weeds, and improve soil quality.",
    steps: [
      "Clear weeds from the area",
    ...
    proTip:
      "Use black plastic mulch for warm-season crops to increase soil temperature.",
  },
  {
    id: 5,
    icon: "🌾",
    name: "Green Manuring",
    overview:
      "Grow and incorporate specific plants into soil to add nutrients and organic matter.",
    steps: [
      "Select appropriate green manure crop",
      "Sow seeds at recommended density",
      "Allow to grow for 6-8 weeks",
      "Incorporate before flowering",
      "Wait 2-3 weeks before planting main crop",
    ],
    benefits: [
    ...
    tools: [
      "Legume seeds (dhaincha, sunhemp)",
      "Tractor/cultivator",
      "Irrigation system",
    ],
    proTip:
      "Dhaincha (Sesbania) is excellent for waterlogged conditions and adds 80-100 kg N/ha.",
  },
  {
    id: 6,
    icon: "💧",
    ...
    overview:
      "Deliver water directly to plant roots through a network of pipes and emitters for maximum efficiency.",
    steps: [
      "Design system layout for your field",
      "Install main and sub-main pipes",
      "Place drip laterals along crop rows",
    ...
    tools: [
      "Drip pipes and emitters",
      "Filter unit",
      "Pressure gauge",
      "Fertilizer tank",
    ],
    proTip:
      "Flush drip lines weekly to prevent clogging from mineral deposits.",
  },
  {
    id: 7,
    icon: "🪱",
    ...
    overview:
      "Use earthworms to convert organic waste into high-quality compost (vermicast).",
    steps: [
      "Set up vermicompost bed (1m x 2m)",
      "Add bedding material (coir, straw)",
      "Introduce red wigglers (Eisenia fetida)",
      "Add organic waste in thin layers",
    ...
    tools: [
      "Vermicompost bed/bin",
      "Red wiggler worms",
      "Organic waste",
      "Moisture meter",
    ],
    proTip:
      "Maintain moisture at 60-70% and temperature between 15-25°C for optimal worm activity.",
  },
  {
    id: 8,
    icon: "🦠",
    name: "Biofertilizers",
    overview:
      "Use beneficial microorganisms to enhance soil fertility and plant nutrient uptake.",
    steps: [
      "Select appropriate biofertilizer (Rhizobium, PSB, etc.)",
      "Mix with carrier material",
      "Apply as seed treatment or soil application",
    ...
    proTip:
      "Never mix biofertilizers with chemical fertilizers or fungicides as they kill beneficial microbes.",
  },
  {
    id: 9,
    icon: "🌱",
    name: "Intercropping",
    overview:
      "Grow two or more crops simultaneously in the same field to maximize land use and reduce risks.",
    steps: [
      "Select compatible crop combinations",
      "Plan row arrangements",
      "Adjust plant spacing accordingly",
      "Manage nutrients for both crops",
    ...
    proTip:
      "Pair tall crops with short ones (maize + beans) for optimal light utilization.",
  },
  {
    id: 10,
    icon: "🌧️",
    ...
    overview:
      "Collect and store rainwater for agricultural use during dry periods.",
    steps: [
      "Assess catchment area and rainfall",
      "Design storage structure (farm pond)",
      "Construct bunds and channels",
    ...
    proTip:
      "A 1-acre farm pond can store enough water to irrigate 5-7 acres during dry spells.",
  },
  {
    id: 11,
    icon: "⚗️",
    name: "Soil pH Management",
    overview:
      "Monitor and adjust soil pH to optimize nutrient availability for crops.",
    steps: [
      "Test soil pH using kit or lab",
      "Identify target pH for your crop",
      "Apply lime to raise pH (acidic soil)",
      "Apply sulfur to lower pH (alkaline soil)",
    ...
    proTip:
      "Most crops prefer pH 6.0-7.0. Test soil every 2-3 years for best results.",
  },
  {
    id: 12,
    icon: "🌰",
    name: "Seed Treatment & Selection",
    overview:
      "Treat and select quality seeds to improve germination, disease resistance, and yield.",
    steps: [
      "Select certified, disease-free seeds",
      "Test germination rate",
      "Treat with fungicide/biofertilizer",
      "Dry treated seeds in shade",
                ...
                <div className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                  <div className="p-6">
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setExpanded(expanded === tech.id ? null : tech.id)
                      }
                  ...
                  {expanded === tech.id && (
                    <div className="border-t border-eco-primary/10 p-6 bg-eco-light space-y-4">
                      <div>
                        <h4 className="font-semibold text-eco-dark mb-2">
                          📋 {t("steps")}
                        </h4>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {tech.tools.map((tool) => (
                            <span
                              key={tool}
                              className="bg-white text-eco-dark text-xs px-2 py-1 rounded-full border border-eco-primary/20"
                            >
                              {tool}
                            </span>
                          ))}
                      ...
                      <div className="bg-eco-primary/10 rounded-xl p-3">
                        <h4 className="font-semibold text-eco-primary mb-1">
                          💡 {t("proTip")}
                        </h4>
      ...
      <section className="py-12 bg-eco-dark text-white text-center">
        <AnimatedSection animation="fadeIn">
          ...
          <p className="text-white/80 mb-6">
            Apply these techniques and see the difference in your harvest.
          </p>
          <a href="/contact" className="eco-btn-secondary inline-block">
            Contact Our Experts
          </a>
        </AnimatedSection>
      </section>
